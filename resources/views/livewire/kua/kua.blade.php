<div>
    @livewire('kua.form')
    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200"> KUA </h2>
    <!-- CTA -->
    <div
        class="flex items-center  p-4 mb-8 text-sm font-semibold text-green-100 bg-green-600 rounded-tl-3xl shadow-md focus:outline-none focus:shadow-outline-green">
        <div class="flex items-center">
            ...
            <span class="text-base">Berisi daftar kantor KUA di Kabupaten Mamuju</span>
        </div>
    </div>
    <div class="w-full overflow-hidden rounded-lg shadow-xs">
        <div class="w-full overflow-x-auto">
            @if (session('message'))
            <div class="flex items-center bg-green-400 text-white text-sm font-bold px-3 py-2" role="alert">
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center space-x-4 text-sm">
                                <button wire:click="$emitTo('kua.form', 'edit', {{ $kua->id }})"
                                ...
                                <button wire:click="$emitTo('kua.form', 'delete', {{ $kua->id }})"
