                ...
                <table class="w-full whitespace-no-wrap">
                    <thead>
                        <tr
                            ...
                            <th class="px-4 py-3" rowspan="2">Kelurahan/Desa</th>
                            <th class="px-4 py-3" rowspan="2">Luar Kantor</th>
                            <th class="px-4 py-3" rowspan="2" colspan="4">Bebas Biaya</th>
                            <th class="px-4 py-3" rowspan="2">Jml NR</th>
                            <th class="px-4 py-3" rowspan="2">Total PNBP</th>
                            <th class="px-4 py-3" rowspan="2">Berdasarkan Usia</th>
                        </tr>
                    </thead>
